                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <div className="flex gap-4 mb-6">
                            <Link href="https://www.instagram.com/deez_prints/" target="_blank" rel="noopener noreferrer" className="p-2 bg-secondary/20 rounded-full hover:bg-white hover:text-black transition-all duration-300 border border-white/10" aria-label="Instagram"><Instagram className="h-4 w-4" /></Link>
                            <Link href="https://www.facebook.com/profile.php?id=61556303432172" target="_blank" rel="noopener noreferrer" className="p-2 bg-secondary/20 rounded-full hover:bg-white hover:text-black transition-all duration-300 border border-white/10" aria-label="Facebook"><Facebook className="h-4 w-4" /></Link>
