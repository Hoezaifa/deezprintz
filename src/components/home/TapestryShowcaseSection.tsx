...
const TAPESTRY_PRODUCTS = [
    {
        ...
        price: 1000,
        image: getCloudinaryUrl("https://res.cloudinary.com/dsjnjbsgi/image/upload/v1773597161/tapestry_hr14wa.webp"),
        href: "/products/tapestry-berserk-eclipse"
    },
    {
        title: "Cyber City Night Tapestry",
        price: 2000,
        image: getCloudinaryUrl("https://res.cloudinary.com/dsjnjbsgi/image/upload/v1773597161/tapestry_hr14wa.webp"), // Placeholder/Sample
                ...
                <div className="relative w-full flex flex-col gap-8 md:gap-12">
                    ...
                    <div className="md:hidden relative">
                        ...
                        <div className="relative h-[280px] rounded-2xl overflow-hidden mb-6">
                            <Image
                                src={getCloudinaryUrl("https://res.cloudinary.com/dsjnjbsgi/image/upload/v1773597161/tapestry_hr14wa.webp")}
                            ...
                            <div className="absolute bottom-0 left-0 p-5 z-10">
                                ...
                                <Link prefetch={true} href="/collections/tapestries" className="inline-flex items-center gap-1 text-[10px] font-bold text-white/60 hover:text-white uppercase tracking-widest transition-colors">
                                    SHOP NOW →
                                </Link>
                            </div>
                        </div>
                    ...
                    <div className="hidden md:block">
                        <div className="flex flex-row items-center">
                            ...
                            <div className="relative w-[55%] h-[320px]">
                                ...
                                <Image src={getCloudinaryUrl("https://res.cloudinary.com/dsjnjbsgi/image/upload/v1773597161/tapestry_hr14wa.webp")} alt="Tapestry in a room" fill sizes="55vw" className="object-cover object-center rounded-2xl" />
                            </div>
                        </div>
